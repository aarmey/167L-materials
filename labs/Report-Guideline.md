...
Follow this layout for EACH lab report. Note that reports may cover multiple labs. Format with 1" margins, arial font type, size 12. There is no specific page limit; however, remain within the above guidelines for each section.
